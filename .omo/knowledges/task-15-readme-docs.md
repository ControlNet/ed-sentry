...
- `README.md` is the Phase 1 user-facing source for local CLI usage. It presents `ed-sentry` as an independently implemented Elite Dangerous Journal AFK monitor, not a fork, port, or copy.
