...
- `ed_afk_monitor::state::SessionState` is the public state model for AFK session consumers. It exposes commander, ship, system, mode, lifecycle timestamps, shield/hull/fighter status, scan/kill counts, bounty total, active massacre mission IDs, mission totals, and last kill/scan timestamps.
